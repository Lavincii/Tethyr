...
***********************************************************/	
	...
	//Get File Ext   
		$ImageType = @explode('/Tethyr', $_FILES['image']['type']);
		$type = $ImageType[1]; //file type	
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/Tethyr/assets/images/profile_pics';
	//Set File name	
...
<div id="Overlay" style=" width:100%; height:100%; border:0px #990000 solid; position:absolute; top:0px; left:0px; z-index:2000; display:none;"></div>
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" class="cropping_container">  
	    
	        <div id="CroppingArea" style="width:500px; max-height:400px; position:relative; overflow:auto; margin:40px 0px 40px 40px; border:2px #666 solid; float:left;">	
